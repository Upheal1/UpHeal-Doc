...
for x, y, label in stages:
    box = mpatches.FancyBboxPatch((x - 0.95, y - 0.28), 1.9, 0.56, boxstyle="round,pad=0.04", facecolor='#E8F0FE', edgecolor='#4C8BF5', linewidth=1.0)
    ax.add_patch(box)
...
# Layers (compact 3-column layout)
layers = [
    (3.0, 4.5, 'Flutter\nMobile App', '#4C8BF5'),
    (1.2, 3.4, 'FastAPI\nBackend', '#34A853'),
    (3.0, 3.4, 'Supabase\nAuth + DB', '#34A853'),
    ...
    (3.0, 2.3, 'RunPod\nVoice', '#FBBC05'),
    (4.8, 2.3, 'Memory &\nContext', '#FBBC05'),
    (1.5, 1.2, 'Journal', '#9C27B0'),
    (3.0, 1.2, 'Mood', '#9C27B0'),
    (4.5, 1.2, 'RAG', '#9C27B0'),
]

for x, y, label, color in layers:
    box = mpatches.FancyBboxPatch((x - 0.55, y - 0.28), 1.1, 0.56, boxstyle="round,pad=0.04", facecolor=color, edgecolor='#333333', linewidth=0.8, alpha=0.9)
    ax.add_patch(box)
    text_color = 'white' if color in ['#4C8BF5', '#34A853', '#9C27B0'] else '#333333'
    ax.text(x, y, label, ha='center', va='center', fontsize=7, color=text_color, fontweight='bold')
